...
var real__compare = asm["_compare"]; asm["_compare"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__compare.apply(null, arguments);
};
...
var real__shallowEqual = asm["_shallowEqual"]; asm["_shallowEqual"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__shallowEqual.apply(null, arguments);
};
